...
* **Legal, Ethical, and Privacy Constraints:** If data contains sensitive personal information, or if consent agreements state data must be destroyed at the end of a study, you are legally obligated to delete it. Data can be requested by the person it is about and they can request the date is deleted or amended, see the Personal Data Access Policy of your institution. 
    - [Newcastle][apd_ncl]
    - [Exeter][apd_exe]
    - [Oxford][apd_ox]
    - [Hull][apd_hu]
...
Contact NUIT for advice if you have concerns. 
 ...
 Hard Drives and Solid State Drives behave differently when it comes to secure data deletion. Various institutions will have their own policies and services. For example
 
 - [Newcastle University][sd_ncl].
 - [University of Edinburgh][sd_edi].
 - [UK Data Service][sd_uds].
 - [UCL][sd_ucl].
...
Many institutions provide remote servers or shared network storage (like Newcastle University's [Research Data Warehouse][ds_ncl] or Edinburgh's [DataStore][ds_edi]) for storing massive datasets. Managing files here is fundamentally different.
...
:::::::::::::::: caution
Due to various data retention policies from institutions and funders make sure you are allowed to delete data before you do. 
:::::::::::::::
...
[sd_ncl]: https://services.ncl.ac.uk/itservice/help-services/security/datadeviceprotection/
[sd_edi]: https://infosec.ed.ac.uk/how-to-protect/secure-deletion
[sd_uds]: https://ukdataservice.ac.uk/learning-hub/research-data-management/store-your-data/disposal/
[sd_ucl]: https://www.ucl.ac.uk/advanced-research-computing/platforms-services/information-governance-advisory-service/information-governance-data-destruction
[ds_edi]: https://digitalresearchservices.ed.ac.uk/resources/datastore
[ds_ncl]: https://services.ncl.ac.uk/itservice/core-services/filestore/researchdatawarehouse/
[apd_ncl]: https://www.ncl.ac.uk/data-protection/access-personal-data/
[apd_exe]: https://www.exeter.ac.uk/departments/cgr/ig/policy/#a1
[apd_ox]: https://www.ox.ac.uk/redirects-compliance
[apd_hu]: https://www.hull.ac.uk/asset-library/docs/data-protection-policy.pdf
[apd_yo]: https://www.york.ac.uk/staff/policies/information-policy/index/it-investigations-and-data-access-policy/